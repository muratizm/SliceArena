...
namespace MoreMountains.Tools
{
    ...
    public class MMProgressBar : MMMonoBehaviour
	{
        ...
        /// Test method
        /// </summary>
        public virtual void Plus(float healRatio)
        {
	        float newProgress = BarTarget + healRatio;
        ...
        /// Test method
        /// </summary>
        public virtual void Minus(float damageRatio)
        {
	        float newProgress = BarTarget - damageRatio;
	        newProgress = Mathf.Clamp(newProgress, 0f, 1f);
	        UpdateBar01(newProgress);
        }
